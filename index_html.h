		...
		<center>
			<div class="row" >
				<div class="columnLateral">
					...
					Pos X: &nbsp;<input id="posX" type="text" size="5" /><br />
					Pox Y: &nbsp;<input id="posY" type="text" size="5"  /><br />
				</div>		
			</div>
		</center>
    <script type="text/javascript">
			var joy1 = new JoyStick('joy1Div', {"internalFillColor": "#ff00ff", "externalLineWidth":5,}, function(stickData) {
				posX.value = Math.floor(stickData.x /2.0);
				posY.value = Math.floor(stickData.y /2.0);
        websocket.send(posX.value + ',' + posY.value);
			});
